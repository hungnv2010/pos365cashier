...
export default (props) => {
    ...
    return (
        <View style={{ paddingVertical: 10, paddingHorizontal: 20, backgroundColor: '#fff', borderRadius:5,width:Metrics.screenWidth*0.8}}>
            <Text style={{paddingVertical:10,fontWeight:'bold',fontSize:16}}>{I18n.t('chon_hang_hoa')}</Text>
            <TextInput style={{backgroundColor:'#f2f2f2',paddingVertical:10,paddingHorizontal:5,borderRadius:10}} onChangeText={(text)=>setTextSearch(text)}></TextInput>
