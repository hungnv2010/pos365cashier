            ...
            <KeyboardAwareScrollView>
                <ScrollView style={{ backgroundColor: '#f2f2f2', borderBottomLeftRadius: 10, borderBottomRightRadius: 10 }}>
                    <View style={{ paddingVertical: 10, paddingHorizontal: 10 }}>
                        ...
                        <TouchableOpacity style={[styles.styleButton,{paddingVertical:10}]} onPress={() => { typeModal.current = 2, setOnShowModal(true) }}>
                            <Text>{data.GroupName}</Text>
                            <Image source={images.icon_arrow_down} style={{ width: 18, height: 18 }} />
                        </TouchableOpacity>
                    ...
                    <View style={{ paddingVertical: 10, paddingHorizontal: 10 }}>
                        ...
                        <TouchableOpacity style={[styles.styleButton,{paddingVertical:10}]} onPress={() => { typeModal.current = 1, setOnShowModal(true) }}>
                    ...
                    <View style={{ flexDirection: 'row', paddingVertical: 10, paddingHorizontal: 10 }}>
                        <View style={{ flex: 1, marginRight: 5 }}>
                            ...
                            <TextInput style={styles.styleTextInput} keyboardType={'numbers-and-punctuation'} value={data.DebtFrom ? currencyToString(data.DebtFrom) : 0 + ''} onChangeText={(text) => { setData({ ...data, DebtFrom: onChangeTextInput(text) }) }} />
                        </View>
                        <View style={{ flex: 1, marginLeft: 5 }}>
                            <Text>{I18n.t('den')} (VND)</Text>
                            <TextInput style={styles.styleTextInput} keyboardType={'numbers-and-punctuation'} value={data.DebtTo ? currencyToString(data.DebtTo) : 0 + ''} onChangeText={(text) => { setData({ ...data, DebtTo: onChangeTextInput(text) }) }} />
                        </View>
                    </View>
                </ScrollView>
            </KeyboardAwareScrollView>
            <TouchableOpacity style={{ marginHorizontal: 30, paddingVertical: 12, marginVertical: 20, backgroundColor: colors.colorLightBlue, alignItems: 'center', justifyContent: 'center', borderRadius: 10 }} onPress={() => onClickOk()}>
