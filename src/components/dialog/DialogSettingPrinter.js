        ...
        <View style={{backgroundColor:'#fff',borderRadius:16}}>
            ...
            <View style={{paddingHorizontal:20,flexDirection:'row',paddingVertical:20}}>
                <View style={{flex:1}}>
                    ...
                    <TextInput style={[styles.styleTextInput,{marginRight:10}]} placeholder={'58..80 mm'} keyboardType={'numeric'}  onChangeText={(text)=> setPrinter({...printer,size:parseInt(text)>80?'80':parseInt(text)<58?'58':text})} editable={printer.type != ''? true:false}></TextInput>
                </View>
                <View style={{flex:1}}>
