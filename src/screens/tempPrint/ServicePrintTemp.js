...
export const handerDataPrintTempProduct = async (data = ProductDefault, size = "40x30") => {
    ...
    data.forEach((element, index) => {
        tempList += (index == 0 ? "" : "|||") + `SIZE ${width} mm, ${height} mm
                    ...
                    BARCODE 10,110,"128",60,1,0,2,2,"${element.Code ? element.Code : ""}"
