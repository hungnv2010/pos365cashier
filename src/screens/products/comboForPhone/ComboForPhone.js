                ...
                <View style={{ paddingHorizontal: 5, paddingVertical: 5, flexDirection: 'row', marginBottom: 5, alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <View style={{ flex: 1.2, marginLeft: 5 }}>
                        ...
                        <View style={{ flexDirection: 'row', backgroundColor: '#f2f2f2', borderRadius: 5, marginTop: 5, borderWidth: 0.5, borderColor: '#36a3f7' }}>
                            ...
                            <TextInput style={{ flex: 2.5, textAlign: 'center', padding: 10, color: '#36a3f7', fontWeight: 'bold' }} keyboardType={'numbers-and-punctuation'} value={item.Quantity ? currencyToString(item.Quantity) : 0 + ''} onChangeText={(text) => { item.Quantity = (onChangeTextInput(text) <= 100000000 ? onChangeTextInput(text) : 100000000), setListFormular([...listFomular]) }}></TextInput>
                    ...
                    {product.LargeUnit ?
                        <View style={{ flex: 1.7, marginLeft: 5 }}>
                            ...
                            <View style={{ flexDirection: 'row', backgroundColor: '#f2f2f2', borderRadius: 5, marginTop: 5, borderWidth: 0.5, borderColor: '#36a3f7' }}>
                                ...
                                <TextInput style={{ flex: 2.5, textAlign: 'center', padding: 10, color: '#36a3f7', fontWeight: 'bold' }} keyboardType={'numbers-and-punctuation'} value={item.QuantityLargeUnit ? currencyToString(item.QuantityLargeUnit) : 0 + ''} onChangeText={(text) => { item.QuantityLargeUnit = (onChangeTextInput(text) <= 100000000 ? onChangeTextInput(text) : 100000000), setListFormular([...listFomular]) }}></TextInput>
