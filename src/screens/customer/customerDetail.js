...
export default (props) => {
    ...
    useEffect(() => {
        ...
        if (!customerDetail.PartnerGroupMembers) return
    ...
    }, [customerDetail.PartnerGroupMembers])
        ...
        return typeModal.current == 1 ?
            ...
            typeModal.current == 2 ?
                ...
                <View style={{
                    ...
                    <View>
                        <Text style={{ fontSize: 20, fontWeight: "bold", textAlign: "center", paddingVertical: 10 }}>{I18n.t('chon_nhom')}</Text>
                        {
    ...
    const getGroupName = useCallback(() => {
        ...
        if (customerDetail.PartnerGroupMembers && customerDetail.PartnerGroupMembers.length > 0) {
            customerDetail.PartnerGroupMembers.forEach(item => {
