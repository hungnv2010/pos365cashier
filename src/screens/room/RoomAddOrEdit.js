...
export default (props) => {
    ...
    useEffect(async () => {
        ...
        //     roomGroups.current = [{ Id: "", Name: "Không xác định" }].concat(Object.keys(roomGroups.current).map((key) => roomGroups.current[key]));
        ...
        //     listProductService.current = [{ Id: "", Name: "Không xác định" }].concat(listProductService.current);
        //     if (props.route.params != undefined) {
    ...
    // const onClickApply = () => {
    //     // Room: {Name: "Bàn 2", Printer: "12", RoomGroupId: 40513, Position: 9, Description: "xyz",…}
    //     // Description: "xyz"
    //     // Name: "Bàn 2"
    //     // Position: 9
    //     // Printer: "12"
    //     // Product: {Id: 9623157, Code: "KA-0017", Name: "Don phòng", AttributesName: "", Price: 0, PriceLargeUnit: 0,…}
    //     // ProductId: 9623157
    //     // RoomGroupId: 40513
    //     let params = {
    //         Room: {
    ...
    //                     <TextInput style={{ padding: 10, flex: 1, color: "#000" }} value={itemRoomGroupAdd} onChangeText={(text) => setRoomGroupAdd(text)} placeholder="Tên nhóm" placeholderTextColor="gray" />
    //                 </View>
